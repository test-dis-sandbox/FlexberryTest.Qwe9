namespace Qwe.ApplicationLayer.Mapping
{
    ...
    /// <summary>
    /// Статический маппер для преобразования между сущностью <see cref="Faculty"/> и её DTO.
    /// </summary>
    public static class FacultyMapper
    {
        /// <summary>
        /// Преобразует <see cref="Faculty"/> в указанный DTO.
        /// </summary>
        /// <typeparam name="TDto">Тип DTO.</typeparam>
        /// <param name="source">Исходная сущность.</param>
        /// <returns>Указанный DTO.</returns>
        public static TDto MapToDto<TDto>(this Faculty source)
        ...
        /// <summary>
        /// Обновляет поля сущности <see cref="Faculty"/> по данным из DTO.
        /// </summary>
        /// <typeparam name="TDto">Тип DTO.</typeparam>
        /// <param name="destination">Сущность, которую нужно обновить.</param>
        /// <param name="source">DTO с новыми значениями.</param>
        public static void UpdateFromDto<TDto>(this Faculty destination, TDto source)
            where TDto : FacultyDtoBase
        {
            if (source == null)
            {
                throw new ArgumentNullException(nameof(source));
